...
from cv2 import imread, cvtColor, threshold, findContours, COLOR_BGR2GRAY, RETR_TREE, CHAIN_APPROX_SIMPLE
from cv import CreateImageHeader, SetData, GetMat, IPL_DEPTH_8U
...
class EFD(object):
    ...
    def get_curve(self):
        ...
        contours, hierarchy = findContours(im, RETR_TREE, CHAIN_APPROX_SIMPLE)
        ...
        # # Debugging
        # im_ = Image.new('RGB', (1200,1200), (255,255,255))
        # pixs = im_.load()
        # for pos in xy_:
        #     pixs[pos] = (0,0,0)
        # im_.show()
